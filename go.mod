module github.com/wgpsec/lc

go 1.22.1

require (
	github.com/alibabacloud-go/cdn-20180510/v5 v5.0.0
	github.com/alibabacloud-go/cloudapi-20160714/v5 v5.4.3
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/lighthouse v1.0.893
